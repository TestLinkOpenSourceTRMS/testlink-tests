...
#
echo 'Testing TestLink REST API - PUT /executions'
curl -i -H "Content-Type: application/json" -X POST --data "@../json/createTestCaseExecution.json" \
     -u dev02:thisisnoytmypassword http://localhost/development/tlrepo/lib/api/rest/v1/executions